      ...
      try {
        ...
        const featuredStories = topStoriesData
          ...
          .map(story => ({
            ...
            imageUrl: story.articles.featured_image || story.articles.cover_image || 'https://images.unsplash.com/photo-1531415074968-036ba1b575da?q=80&w=1200&auto=format&fit=crop',
