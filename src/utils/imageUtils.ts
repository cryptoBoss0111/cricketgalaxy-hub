...
const knownImages: Record<string, string> = {
  'MI': '/lovable-uploads/5b7f4438-0859-4c69-a3ee-5dc05d2cd4bf.png', // Updated Mumbai Indians logo
...
const imageIdMap: Record<string, string> = {
  'ecc2d92f-2f5b-47a3-ae69-17dc0df384cd': '/lovable-uploads/5b7f4438-0859-4c69-a3ee-5dc05d2cd4bf.png', // Updated MI logo
  '2a4ce6cf-adb0-4f0a-9c8a-3353432db175': '/lovable-uploads/5b7f4438-0859-4c69-a3ee-5dc05d2cd4bf.png', // Previous MI logo ID points to new logo
  '1d4a5e68-72f5-4f46-9b46-071be8fdd0fa': '/lovable-uploads/5b7f4438-0859-4c69-a3ee-5dc05d2cd4bf.png', // Previous MI logo ID points to new logo
  'f23e809f-871c-487b-b60f-cb1c0614fc56': '/lovable-uploads/5b7f4438-0859-4c69-a3ee-5dc05d2cd4bf.png', // Older MI logo ID points to new logo
  '0e340cba-e05f-473c-a8f1-8cdefe533c00': '/lovable-uploads/5b7f4438-0859-4c69-a3ee-5dc05d2cd4bf.png', // Direct MI logo ID
  '5b7f4438-0859-4c69-a3ee-5dc05d2cd4bf': '/lovable-uploads/5b7f4438-0859-4c69-a3ee-5dc05d2cd4bf.png', // New MI logo ID
  ...
  '051d2143-4908-4260-975a-746c1c9bd80d': '/lovable-uploads/5b7f4438-0859-4c69-a3ee-5dc05d2cd4bf.png', // Direct MI logo ID
...
export const getOptimizedImageUrl = (url: string, teamShortName?: string): string => {
  ...
  if (teamShortName === 'MI') {
    return '/lovable-uploads/5b7f4438-0859-4c69-a3ee-5dc05d2cd4bf.png';
  }
