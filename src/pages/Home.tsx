    ...
    <>
      ...
      <main>
        ...
        <section className="py-12 bg-gradient-to-b from-white to-gray-50">
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-2xl md:text-3xl font-heading font-bold">Editor's Picks</h2>
              <Link to="/cricket-news" className="flex items-center text-sm font-medium text-cricket-accent hover:underline">
                See All <ChevronRight size={16} className="ml-1" />
              </Link>
            </div>
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-heading font-bold mb-8 text-center">Explore Categories</h2>
            
            <Tabs defaultValue="ipl" className="w-full">
              <TabsList className="grid grid-cols-3 md:grid-cols-6 mb-8">
                <TabsTrigger value="ipl">IPL 2025</TabsTrigger>
                <TabsTrigger value="worldcup">World Cup</TabsTrigger>
                <TabsTrigger value="womens">Women's Cricket</TabsTrigger>
                <TabsTrigger value="fantasy">Fantasy Tips</TabsTrigger>
                <TabsTrigger value="players">Player Profiles</TabsTrigger>
                <TabsTrigger value="previews">Match Previews</TabsTrigger>
              </TabsList>
              
              <TabsContent value="ipl" className="animate-fade-in">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <ArticleCard
                    id="ipl1"
                    title="Parag to captain RR for first three games"
                    excerpt="Riyan Parag will lead Rajasthan Royals in the absence of Sanju Samson for the opening matches"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                    category="IPL 2025"
                    author="Vishal Dikshit"
                    date="Mar 18, 2025"
                  ...
                  <ArticleCard
                    id="ipl2"
                    title="Gill wants Titans to 'maximise powerplay'"
                    excerpt="Gujarat Titans captain emphasizes aggressive approach in the first six overs"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                    category="IPL 2025"
                    author="Alagappan Muthu"
                    date="Mar 17, 2025"
                  ...
                  <ArticleCard
                    id="ipl3"
                    title="IPL: Jayawardene banks on MI's core and 'old faces'"
                    excerpt="Mumbai Indians head coach confident about team's combination despite changes"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                    category="IPL 2025"
                    author="Vishal Dikshit"
                    date="Mar 16, 2025"
              ...
              <TabsContent value="worldcup" className="animate-fade-in">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <ArticleCard
                    id="wc1"
                    title="ICC announces schedule for T20 World Cup 2026"
                    excerpt="The next T20 World Cup will feature 20 teams across 4 countries in a new format"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                    category="World Cup"
                  ...
                  <ArticleCard
                    id="wc2"
                    title="Netherlands secure qualification for 2026 T20 World Cup"
                    excerpt="Dutch team continues their impressive run in global tournaments"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                    category="World Cup"
                  ...
                  <ArticleCard
                    id="wc3"
                    title="ICC introduces new format for Champions Trophy 2025"
                    excerpt="Eight-team tournament to feature a revised structure to increase competitiveness"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                    category="ICC Events"
                    author="ESPNcricinfo Staff"
                    date="Mar 12, 2025"
              ...
              <TabsContent value="womens" className="animate-fade-in">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <ArticleCard
                    id="w1"
                    title="Grace Harris joins Surrey Women for Vitality Blast"
                    excerpt="Australian star signs up for English domestic T20 competition"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                  ...
                  <ArticleCard
                    id="w2"
                    title="India Women announce squad for England series"
                    excerpt="Several new faces included as selectors look to build for the future"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                    category="Women's Cricket"
                  ...
                  <ArticleCard
                    id="w3"
                    title="Women's IPL 2025 to feature two new teams"
                    excerpt="BCCI announces expansion of women's T20 league to further grow the game"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                    category="Women's Cricket"
                    author="Annesha Ghosh"
                    date="Mar 12, 2025"
              ...
              <TabsContent value="fantasy" className="animate-fade-in">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <ArticleCard
                    id="f1"
                    title="Fantasy Guide: Top picks for IPL 2025's opening week"
                    excerpt="Expert recommendations for your fantasy teams in the first round of matches"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                  ...
                  <ArticleCard
                    id="f2"
                    title="Budget options that could outperform their price in IPL 2025"
                    excerpt="Finding value picks who could deliver big returns in fantasy cricket"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                    category="Fantasy Tips"
                    author="Fantasy Expert"
                    date="Mar 16, 2025"
                  ...
                  <ArticleCard
                    id="f3"
                    title="Captain choices: The differentiators for fantasy success"
                    excerpt="Selecting the right captain could be the key to winning your fantasy leagues"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                    category="Fantasy Tips"
                    author="Fantasy Expert"
                    date="Mar 15, 2025"
              ...
              <TabsContent value="players" className="animate-fade-in">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <ArticleCard
                    id="p1"
                    title="The rise of Yashasvi Jaiswal: India's newest batting sensation"
                    excerpt="Tracing the journey of the young opener who has taken international cricket by storm"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                  ...
                  <ArticleCard
                    id="p2"
                    title="Jofra Archer: The comeback trail of England's pace ace"
                    excerpt="After battling injuries, the speedster is ready to reclaim his place in world cricket"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                    category="Player Profile"
                  ...
                  <ArticleCard
                    id="p3"
                    title="Suryakumar Yadav: The evolution of a T20 maestro"
                    excerpt="How SKY transformed himself into one of the most feared T20 batsmen in the world"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                    category="Player Profile"
                    author="Vishal Dikshit"
                    date="Mar 13, 2025"
              ...
              <TabsContent value="previews" className="animate-fade-in">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <ArticleCard
                    id="mp1"
                    title="CSK vs MI: El Clásico returns to kick off IPL 2025"
                    excerpt="The tournament's biggest rivalry set to light up the opening day in Chennai"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                  ...
                  <ArticleCard
                    id="mp2"
                    title="India vs England: Test rivalry resumes at iconic Lord's"
                    excerpt="Preview of the first Test between two evenly matched teams"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                    category="Match Preview"
                  ...
                  <ArticleCard
                    id="mp3"
                    title="Australia vs South Africa: Battle for ODI supremacy"
                    excerpt="Two powerhouses clash in a series that could reshape the ODI rankings"
                    imageUrl="https://images.unsplash.com/photo-1624971497044-3b338527dc4c?q=80&w=600&auto=format&fit=crop"
                    category="Match Preview"
        ...
        <section className="py-16 bg-cricket-dark text-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4">Stay Updated</h2>
              <p className="text-gray-300 mb-8">
                Subscribe to our newsletter to receive the latest cricket news, match updates, and exclusive content directly in your inbox.
              </p>
              ...
              <p className="text-xs text-gray-400 mt-4">
                By subscribing, you agree to our Privacy Policy and consent to receive updates from CricketExpress.
              </p>
            </div>
          </div>
        </section>
