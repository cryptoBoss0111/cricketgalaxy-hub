...
const AdminLogin = () => {
        ...
        if (data.session) {
          ...
          try {
            ...
            if (adminUser.id) {
              ...
              // No valid user info in stored data
              localStorage.removeItem('adminToken');
              localStorage.removeItem('adminUser');
            }
          } catch (e) {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-50 px-4">
      {checkingSession ? (
        <div className="w-full max-w-md bg-white rounded-xl shadow-soft p-8 border border-gray-100 flex justify-center items-center">
